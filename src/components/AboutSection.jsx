...
import { Briefcase, ChartBarDecreasing, Code, Database, Network, ProjectorIcon } from "lucide-react";
                        ...
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground">
                                       Enthusiastic fresher with a keen grasp of project management principles,
                                        eager to coordinate tasks, timelines, and teamwork to drive successful outcomes.
